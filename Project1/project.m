...
% el = 0.5;
% 
% % figure out how many samples per sweep. Multiply by two to
% % account for I and Q data
% samples_per_sweep = num_az * 2 * (num_pulses * num_gates + num_short_pulses * num_short_gates);
% 
